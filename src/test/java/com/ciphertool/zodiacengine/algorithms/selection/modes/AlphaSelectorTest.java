...
public class AlphaSelectorTest {
	...
	public void testSpinIndexRouletteWheel() {
		...
		assertEquals(population.getIndividuals().get(winningNumber).getFitness(), new Double(
				10000.0));
