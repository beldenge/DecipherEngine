...
import com.ciphertool.engine.fitness.impl.CipherSolutionMultipleFitnessEvaluator;

public class CipherSolutionMultipleFitnessEvaluatorTest extends FitnessEvaluatorTestBase {
	@Test
	public void testEvaluate() {
		...
		assertEquals(new Double(602.0), fitness);
