...
import com.ciphertool.engine.fitness.impl.CipherSolutionMagicWordFitnessEvaluator;

public class CipherSolutionMagicWordFitnessEvaluatorTest extends FitnessEvaluatorTestBase {
	@Test
	public void testEvaluate() {
		CipherSolutionMagicWordFitnessEvaluator fitnessEvaluator = new CipherSolutionMagicWordFitnessEvaluator();
