...
import com.ciphertool.engine.dao.PlaintextSequenceDao;
...
public class PlaintextSequenceDaoTest {
	...
	public void testFindRandomSequence() {
		...
		PlaintextSequence sequence = (PlaintextSequence) plaintextSequenceDao.findRandomSequence(gene, arbitraryInteger);
	...
	public void testFindRandomSequenceNullGene() {
		...
		PlaintextSequence sequence = (PlaintextSequence) plaintextSequenceDao.findRandomSequence(null, arbitraryInteger);
