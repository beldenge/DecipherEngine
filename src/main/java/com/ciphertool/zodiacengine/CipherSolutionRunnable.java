...
public class CipherSolutionRunnable implements Runnable {
	 ...
	 * @param cipherDto
	 */
	public CipherSolutionRunnable(long numIterations, SolutionGenerator solutionGenerator,
	...
	public void run() {
		...
		for (int i = 0; i < numIterations; i++) {
			...
			// we need the confidence level several times, so just call the
			// getter once and store in a temp variable
