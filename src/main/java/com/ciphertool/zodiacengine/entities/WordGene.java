...
package com.ciphertool.DecipherEngine.entities;
...
public class WordGene implements VariableLengthGene {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ciphertool.DecipherEngine.genetic.Gene#replaceSequence(int, com.ciphertool.DecipherEngine.genetic.Sequence)
	 */
	@Override
	@Dirty
